    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <p>a Platform based In Sylhet, designed to make the process of finding a job or an employee easier for the user. Not a single job will go unnoticed.</p>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="{{route('employer.register')}}">Employer Reg</a></li>
                            <li><a href="{{route('register')}}">Employee Reg</a></li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <h3 class="footer-heading mb-4 text-white">Jobs</h3>
                        <ul class="list-unstyled">
