                        ...
                        <div class="col-md-12 col-lg-8 mb-5">
                            ...
                            <form method="POST" action="{{route('register')}}" class="p-5 bg-white">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input id="password-confirm" type="password" placeholder="Password again" class="form-control" name="password_confirmation" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <input type="submit" value="Register as Employee" class="btn btn-primary  py-2 px-5">
                                    </div>
                                </div>
